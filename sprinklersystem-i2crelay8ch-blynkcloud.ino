...
//#include <blynk.h>
#define BLYNK_TEMPLATE_ID "TMPLsEJbt5rU"
#define BLYNK_DEVICE_NAME "LawnSprinkler I2Crelay"
/////////************* **********/////////
//          Blynk Assignments           //
/////////************* **********/////////
/*
...
V2   - Water Pressure
V3   - Temperature
V4   - bat power  2 pins for power status one for bat and one for usb
V5   - Power LED
V9   - Last reboot
V10  - (Terminal)
V11  - Freeze temp input shut off point
V21  - Manual Valve switch input (Styled Button)
|||  - reserved
V45  - 21-45 reserved for inputs (Styled Button) more???
>>>V1<<<
...
#endif
#ifdef LV
char auth[] = "Lxjo-3HjNU-J9LGbpkrrqmQeOvWqzf59";
